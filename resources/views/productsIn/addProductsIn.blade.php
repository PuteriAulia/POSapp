...
@section('title','Kasir | Tambah Barang Masuk')
        ...
        <form action="/barangMasuk" method="POST">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Tambah barang masuk</h3>
                    ...
                    <div class="row justify-content-center py-sm-3 py-md-5">
                        <div class="col-sm-10 col-md-8">
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label for="block-form1-id">Id barang masuk</label>
                                        <input type="text" class="form-control form-control-alt" id="block-form1-id" name="id" value="{{ $productInId }}" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-alt" id="block-form1-qty" name="qty" placeholder="Masukkan jumlah barang masuk.." required>
                            </div>

                            <div class="form-group">
                                <label for="block-form1-date">Tanggal</label>
                                <input type="date" class="form-control form-control-alt" id="block-form1-date" name="date" placeholder="Masukkan tanggal barang masuk.." required>
                            </div>
